...
pub mod cat {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_cuteness(self) -> f32 {
      self.reader.get_data_field::<f32>(1)
    }
    #[inline]
    pub fn get_addresses(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,crate::cats_capnp::cat::address::Owned>> {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_cuteness(&mut self, value: f32)  {
      self.builder.set_data_field::<f32>(1, value);
    }
    #[inline]
    pub fn get_addresses(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,crate::cats_capnp::cat::address::Owned>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(2), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_addresses(&mut self, value: ::capnp::struct_list::Reader<'a,crate::cats_capnp::cat::address::Owned>) -> ::capnp::Result<()> {
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.reborrow().get_pointer_field(2), value, false)
    }
    #[inline]
    pub fn init_addresses(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::cats_capnp::cat::address::Owned> {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 115] = [
      ...
      ::capnp::word(5, 94, 242, 151, 135, 120, 50, 152),
      ::capnp::word(11, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(102, 43, 249, 60, 245, 213, 98, 157),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(99, 97, 116, 115, 46, 99, 97, 112),
      ::capnp::word(110, 112, 58, 67, 97, 116, 0, 0),
      ::capnp::word(4, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(177, 26, 252, 105, 37, 64, 182, 201),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(99, 117, 116, 101, 110, 101, 115, 115),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        ...
        4 => <::capnp::struct_list::Owned<crate::cats_capnp::cat::address::Owned> as ::capnp::introspect::Introspect>::introspect(),
    ...
    pub const TYPE_ID: u64 = 0x9832_7887_97f2_5e05;
  }
  ...
  pub mod address {
    ...
    impl <'a,> Reader<'a,>  {
      ...
      #[inline]
      pub fn get_postalcode(self) -> u16 {
    ...
    impl <'a,> Builder<'a,>  {
      ...
      #[inline]
      pub fn set_street(&mut self, value: ::capnp::text::Reader<'_>)  {
        self.builder.reborrow().get_pointer_field(0).set_text(value);
      }
      #[inline]
      ...
      #[inline]
      pub fn set_postalcode(&mut self, value: u16)  {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 63] = [
        ...
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(99, 97, 116, 115, 46, 99, 97, 112),
        ::capnp::word(110, 112, 58, 67, 97, 116, 46, 65),
        ...
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(112, 111, 115, 116, 97, 108, 99, 111),
      ...
      pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
      pub const TYPE_ID: u64 = 0xc9b6_4025_69fc_1ab1;
    }
  }
}
